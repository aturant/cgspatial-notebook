library(devtools)
#install.packages("velox",dependencies=TRUE, repos='http://cran.rstudio.com/')
...
install.packages("mgcViz",dependencies=TRUE, repos='http://cran.rstudio.com/')
...
install.packages("scico",dependencies=TRUE, repos='http://cran.rstudio.com/')
